...
async function init () {
  ...
  const app = new Vue({
    ...
    template: `
        <div>
            <radio-option label="Search texts in" left="Foreground" right="Background" :active="textActive"
                          @change="setTextActive"></radio-option>
            <radio-option label="Open links in" left="Foreground" right="Background" :active="linkActive"
